---
name: math-modeling
description: 当用户要求数学建模、建模竞赛、建模分析、代码求解、结果可视化、论文生成、竞赛规则核验、优秀案例、练习复盘、错题本、实践复盘或图表检索，或将 PDF、Office 文档和图片批量转换为知识库 Markdown/多模态图片包时使用。支持建模手→编程手→论文手三阶段、单独角色阶段、知识资料预处理，以及九个 Dify 私有知识库的统一 MCP 检索和原图返回。
---
